      ...
      <div className="flex flex-col gap-2 w-full">
        <div className="flex gap-4 w-full justify-between items-center">
          <div className="flex gap-4 w-3/4">
            ...
            <div className="flex w-4/5 text-greyText">
              <div className="w-4/5">
                <p className="font-normal text-sm">Couple Ring (Feather)</p>
                <p className="font-medium text-xs text-black">Ring</p>
              </div>
        ...
        <div className="flex gap-4 w-full justify-between items-center">
          <div className="flex gap-4 w-3/4">
            ...
            <div className="flex w-4/5 text-greyText">
              <div className="w-4/5">
                <p className="font-normal text-sm">Couple Ring (Feather)</p>
                <p className="font-medium text-xs text-black">Necklace</p>
              </div>
              <div className="xl:w-1/5 grid grid-cols-3 place-items-center">
                <button
                  className="col-start-1 col-end-2 flex justify-center items-center border border-solid border-greyText h-4 w-4 text-xs leading-none"
        ...
        <div className="flex gap-4 w-full justify-between items-center">
          <div className="flex gap-4 w-3/4">
            ...
            <div className="flex w-4/5 text-greyText">
              <div className="w-4/5">
                <p className="font-normal text-sm">Couple Ring (Feather)</p>
                <p className="font-medium text-xs text-black">Bracelete</p>
              </div>
              <div className="xl:w-1/5 grid grid-cols-3 place-items-center">
                <button
                  className="col-start-1 col-end-2 flex justify-center items-center border border-solid border-greyText h-4 w-4 text-xs leading-none"
        ...
        <div className="flex gap-4 w-full justify-between items-center">
          <div className="flex gap-4 w-3/4">
            ...
            <div className="flex w-4/5 text-greyText">
              <div className="w-4/5">
                <p className="font-normal text-sm">Wallet (Feather)</p>
                <p className="font-medium text-xs text-black">Wallet</p>
              </div>
              <div className="xl:w-1/5 grid grid-cols-3 place-items-center">
                <button
                  className="col-start-1 col-end-2 flex justify-center items-center border border-solid border-greyText h-4 w-4 text-xs leading-none"
        ...
        <div className="flex flex-col">
          <div className="flex justify-between border-b-2 pb-2">
            <div className="w-2/5">
              <p className="font-semibold text-lg text-greyText">Total</p>
            </div>
            <div className="w-3/5 flex justify-end font-semibold text-lg">
              {calculateTotal()}
            </div>
          </div>
          <div className="flex justify-between mt-2">
            <div className="w-2/5">
              <p className="font-semibold text-lg text-greyText">Grand Total</p>
            </div>
            <div className="w-3/5 flex justify-end font-semibold text-lg">
