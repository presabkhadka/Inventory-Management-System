          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 bg-white rounded-lg p-4 flex flex-col gap-4">
              <div className="flex justify-between items-center">
                <p className="font-medium text-xl leading-7">Maggi</p>
                <div className="flex gap-4">
                  <button className="flex items-center border rounded gap-2 px-3 py-2 font-medium text-sm leading-5 text-greyText">
                    <CiEdit />
                    Edit
                  </button>
                  <button className="flex items-center border rounded gap-2 px-3 py-2 font-medium text-sm leading-5 text-greyText">
                  ...
                  <TabsContent value="overview">
                    <div className="grid grid-cols-12 p-6 gap-y-8">
                      ...
                      <div className="col-span-8 flex flex-col gap-y-6">
                        ...
                        <div className="flex justify-between bg-greyBG opacity-50 px-4 py-2 text-sm font-semibold leading-5">
                          <p>Store Name</p>
                          <p>Stock in hand</p>
                        </div>
                        <div className="flex justify-between px-1 pb-4 border-b-2">
                          <p className="font-medium text-sm leading-5 text-greyish">
                            Sulur Branch
                          </p>
                          <p className="text-button font-medium text-sm leading-5">
                            15
                          </p>
                        </div>
                        <div className="flex justify-between px-1 pb-4 border-b-2">
